          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Community Tech Workshops</span>
              </h3>
              <p className="text-[15px] text-gray-400">
              Empowering Locals with Practical Skills From basic computer literacy to advanced coding, these sessions aim to empower participants with the knowledge and confidence to navigate the digital world.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Innovation Showcases</span>
              </h3>
              <p className="text-[15px] text-gray-400">
              Our showcase events provide a platform for local talent to share their journeys, and inspire others in the community to pursue their tech ambitions.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Tech Talks &amp; Seminars</span>
              </h3>
              <p className="text-[15px] text-gray-400">
              Engage with experts in various fields of technology through our series of informative talks and seminars. These sessions cover a wide range of topics.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
              Our programs specifically target the youth of Kajola, aiming to spark their interest in technology and innovation. Through interactive activities, mentorship opportunities.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Building Solutions Together</span>
              </h3>
              <p className="text-[15px] text-gray-400">
              Encouraging collaboration is at the heart of our mission, These events foster teamwork, creativity, and practical problem-solving skills among participants.
            ...
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span> Digital Literacy Campaigns</span>
              </h3>
              <p className="text-[15px] text-gray-400">
              Our digital literacy campaigns focus on educating the community about the basics of technology, internet safety, and the benefits of digital tools, ensuring no one is left behind.
              </p>
            </article>
          </div>
        </div>
